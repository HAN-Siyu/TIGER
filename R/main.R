...
#' train_samples <- data.FF4_qc[data.FF4_qc$sampleType == "QC",]
#' test_samples  <- data.FF4_qc[data.FF4_qc$sampleType != "QC",]
#'
...
#' # (In this case, batch ID is required.)
